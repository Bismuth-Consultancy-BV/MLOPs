...
def run(input_latents, guided_latents, guiding_strength, guiding_seed, inference_steps, torch_device, model="CompVis/stable-diffusion-v1-4", local_cache_only=True):
